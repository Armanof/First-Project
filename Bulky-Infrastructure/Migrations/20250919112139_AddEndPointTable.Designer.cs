...
namespace Bulky_Infrastructure.Migrations
{
    ...
    [Migration("20250919112139_AddEndPointTable")]
    partial class AddEndPointTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bulky_Models.Identity.EndPoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Bulky_Models.Identity.PermissionEndPoint", b =>
                {
                    b.HasOne("Bulky_Models.Identity.EndPoint", "EndPoint")
                        .WithMany("PermissionEndPoints")
                        .HasForeignKey("F_EndPointID")
